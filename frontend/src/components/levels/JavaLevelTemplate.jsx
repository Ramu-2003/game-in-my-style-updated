...
const JavaLevelTemplate = ({ challenge, course, phase, levelNumber}) => {
  ...
  const handleCompile = async () => {
    ...
    setIsCompiling(true);
    setConsoleOutput([]);
    addConsoleMessage("🔄 Compiling Java...", "info");
            ...
            <div className="flex flex-col">
              <div className="bg-[#1e1e1e] rounded-lg shadow-md overflow-hidden border border-gray-700 flex flex-col" style={{ height: "500px" }}>
                <div className="bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-gray-700">
                  <span className="text-gray-300 text-sm font-mono">Main.java</span>
                  <span className="text-gray-500 text-xs">Java</span>
                </div>
                ...
                <div className="flex-1 overflow-auto p-4 bg-[#1e1e1e]">
                  ...
                  <div className="bg-yellow-900/30 border border-yellow-600/30 rounded-lg p-3">
                    <p className="text-yellow-400 text-xs font-mono">
                      💡 Write Java code that produces this exact output. AI validates your solution — no copy-pasting!
                    </p>
                  </div>
                </div>
