                ...
                <div className="flex-1 overflow-auto p-4 bg-white">
                  {challenge.expectedOutput ? (
                    <div className="h-full flex flex-col">
                      <div className="text-xs text-green-700 font-bold mb-3 uppercase tracking-wider flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4" />
                        Expected Output Preview:
                      </div>
                      <div 
                        className="flex-1 border-2 border-green-300 rounded-lg bg-white p-4 overflow-auto"
                        style={{ minHeight: "350px" }}
                        dangerouslySetInnerHTML={{ __html: challenge.expectedOutput }}
                      />
                      <div className="mt-3 bg-blue-50 border border-blue-200 rounded-lg p-3">
                        <p className="text-xs text-blue-700 font-mono">
                          💡 Your HTML should render exactly like the preview above
                        </p>
                      </div>
                    </div>
                  ) : (
                    <p className="text-gray-400 text-sm">No expected output available</p>
                  )}
                </div>
