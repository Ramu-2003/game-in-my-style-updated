...
const JavaScriptPhase6LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/javascript/phase6/level${levelNumber}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar 
        currentPage="JAVASCRIPT PHASE 6"
        themeKey={themeKey}
...
export default JavaScriptPhase6LevelsPage;
