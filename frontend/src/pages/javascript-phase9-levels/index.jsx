...
const JavaScriptPhase9LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/javascript/phase9/level${levelNumber}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar 
        currentPage="JAVASCRIPT PHASE 9"
        themeKey={themeKey}
...
export default JavaScriptPhase9LevelsPage;
