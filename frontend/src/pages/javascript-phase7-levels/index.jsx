...
const JavaScriptPhase7LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/javascript/phase7/level${levelNumber}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar 
        currentPage="JAVASCRIPT PHASE 7"
        themeKey={themeKey}
...
export default JavaScriptPhase7LevelsPage;
