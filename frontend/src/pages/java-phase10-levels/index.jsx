...
const JavaPhase10LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/java/phase10/level${levelNumber}`);
  };
...
export default JavaPhase10LevelsPage;
