...
const JavaScriptPhase3LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/javascript/phase3/level${levelNumber}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar 
        currentPage="JAVASCRIPT PHASE 3"
        themeKey={themeKey}
...
export default JavaScriptPhase3LevelsPage;
