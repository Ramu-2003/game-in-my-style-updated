...
const JavaScriptPhase2LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/javascript/phase2/level${levelNumber}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar 
        currentPage="JAVASCRIPT PHASE 2"
        themeKey={themeKey}
...
export default JavaScriptPhase2LevelsPage;
