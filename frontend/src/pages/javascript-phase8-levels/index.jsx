...
const JavaScriptPhase8LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/javascript/phase8/level${levelNumber}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar 
        currentPage="JAVASCRIPT PHASE 8"
        themeKey={themeKey}
...
export default JavaScriptPhase8LevelsPage;
