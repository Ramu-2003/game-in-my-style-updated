...
const JavaScriptPhase4LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/javascript/phase4/level${levelNumber}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar 
        currentPage="JAVASCRIPT PHASE 4"
        themeKey={themeKey}
...
export default JavaScriptPhase4LevelsPage;
