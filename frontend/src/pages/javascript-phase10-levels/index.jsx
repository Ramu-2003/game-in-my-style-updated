...
const JavaScriptPhase10LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/javascript/phase10/level${levelNumber}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar 
        currentPage="JAVASCRIPT PHASE 10"
        themeKey={themeKey}
...
export default JavaScriptPhase10LevelsPage;
