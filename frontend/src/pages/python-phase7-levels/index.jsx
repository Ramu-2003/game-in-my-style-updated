...
const PythonPhase7LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/python/phase7/level${levelNumber}`);
  };
    ...
    >
      ...
      <main className="flex-1 px-6 py-14 sm:px-10">
        ...
        <div className="text-center mb-12">
          ...
          >
            PHASE <span style={{ color: currentTheme.accent }}>7</span> LEVELS
          </h1>
...
export default PythonPhase7LevelsPage;
