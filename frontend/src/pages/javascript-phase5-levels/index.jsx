...
const JavaScriptPhase5LevelsPage = () => {
  ...
  const handleLevelStart = (levelNumber) => {
    navigate(`/levels/javascript/phase5/level${levelNumber}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar 
        currentPage="JAVASCRIPT PHASE 5"
        themeKey={themeKey}
...
export default JavaScriptPhase5LevelsPage;
